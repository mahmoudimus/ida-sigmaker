...
def _run_batch_search() -> None:
    input_text = _ask_batch_search_text()
    ...
    if not results:
        ...
        return
    results.display(formatter=BatchSearchTextFormatter(include_function_names=True))
    _maybe_export_batch_results(results)
